    ...
    <div className="space-y-12 max-w-2xl mx-auto pb-24">
      ...
      <div className="flex flex-col items-center text-center space-y-4 pt-4">
        ...
        <div className="space-y-2">
          <h1 className="text-4xl font-extrabold text-slate-900 tracking-tighter uppercase leading-none">Central de Ajuda</h1>
          <p className="text-slate-400 font-bold tracking-widest text-[10px] uppercase opacity-80">Atendimento especializado para inquilinos SLX</p>
        </div>
      </div>
        ...
        <div className="p-10 space-y-10">
           <div className="flex items-center gap-6">
              ...
              <div className="space-y-1">
                <h2 className="text-xl font-extrabold text-slate-900 uppercase tracking-tighter">WhatsApp Direto</h2>
                <p className="text-slate-400 text-sm font-bold opacity-70">Fale com um atendente em tempo real.</p>
              </div>
           </div>
