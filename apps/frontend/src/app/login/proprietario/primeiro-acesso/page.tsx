...
export default function LandlordFirstAccessPage() {
    ...
    <div className="min-h-screen bg-[#020617] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm space-y-8 relative z-10">
        <div className="space-y-2">
          <Link href="/login/proprietario" className="text-slate-500 hover:text-white transition-colors text-xs font-black uppercase tracking-widest flex items-center gap-2 mb-8">
          ...
          <p className="text-slate-400 font-medium leading-relaxed">
            Proprietário, informe seu CPF cadastrado e o e-mail para receber o link de ativação.
          </p>
        </div>
